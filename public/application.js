...
var goalsEvents = __webpack_require__(8);
...
var onCreateGoal = function onCreateGoal(event) {
  ...
  // console.log(event)
  var data = getFormFields(event.target);
  api.createGoal(data).then(ui.createGoalSuccess).catch(ui.createGoalFail);
  // console.log(data)
};

// THIS IS HANDLEBARS FOR LISTING RESOURCE

var onShowAllGoals = function onShowAllGoals(event) {
  // console.log('onShowAllGoals')
  event.preventDefault();
  api.showGoals().then(ui.showGoalsSuccess).catch(ui.showGoalsFail);
};

// THIS IS FOR DELETING A GOAL ON RESOURCE

var onDeleteShownGoals = function onDeleteShownGoals(event) {
  event.preventDefault();
  // console.log('onDeleteShownGoals')
  var goalId = $(event.target).closest('button').attr('data-id');
  // console.log(goalId)
  api.deleteGoals(goalId).then(function () {
    return onShowAllGoals(event);
  }).catch(ui.showGoalsFail);
};

// THIS IS FOR UPDATING A GOAL ON RESOURCE

var onUpdateShownGoals = function onUpdateShownGoals(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var goalId = $(event.target).attr('data-id');
  // console.log(goalId)
  api.updateGoals(goalId, data).then(function () {
    return onShowAllGoals(event);
...
module.exports = {
  ...
  onShowAllGoals: onShowAllGoals,
  onDeleteShownGoals: onDeleteShownGoals,
  onUpdateShownGoals: onUpdateShownGoals
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var showGoals = function showGoals(data) {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/goals',
    data: data,
...
var deleteGoals = function deleteGoals(goalId) {
  return $.ajax({
...
var updateGoals = function updateGoals(goalId, data) {
  return $.ajax({
    url: config.apiUrl + '/goals/' + goalId,
    method: 'PATCH',
    data: data,
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://sleepy-tor-47880.herokuapp.com',
...
var store = __webpack_require__(3);
var showGoalsTemplate = __webpack_require__(12);
...
var createGoalFail = function createGoalFail(data) {
...
var showGoalsFail = function showGoalsFail(error) {
  console.error(error);
};
...
module.exports = {
  ...
  createGoalFail: createGoalFail,
  showGoalsSuccess: showGoalsSuccess,
  showGoalsFail: showGoalsFail
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  "
    ...
    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Update Goal!</button> -->\n  </div>\n\n  <div class=\"handlebar\">\n\n    <form class=\"form-updategoal\" data-id=\""
    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n\n      <h4> Updating your goal now! </h4>\n\n      <div>\n\n        <label>Goal Title</label>\n        <input type=\"text\" class=\"form-control\" name=\"goal[title]\" placeholder=\"Name your Goal\" required=\"true\">\n\n      </div>\n\n      <div>\n\n        <label>Description</label>\n        <input type=\"text\" class=\"form-control\" name=\"goal[description]\" placeholder=\"Describe your goal here...\" required=\"true\">\n\n        <button data-id=\"update-goal\" type=\"submit\" class=\"btn btn-primary\">Update your Goal</button>\n\n      </div>\n\n    </form>\n  </div>\n\n  <hr>\n\n";
